...
var pathToImages = 'image/icones/';	// Relative to your HTML file
...
{
	if(this.src.indexOf('over')>=0){
		this.src = pathToImages + 'close_c.png';
	}else{
...
function writeTopBar()
{
	...
	yearPicker.style.left = '133px';// Modifie la position de la liste annee;
	yearPicker.style.top = monthDiv.offsetTop + monthDiv.offsetHeight + 1 + 'px';
	yearPicker.style.width = '48px';
	yearPicker.id = 'yearDropDown';
	calendarDiv.appendChild(yearPicker);


	var img = document.createElement('IMG');
	img.src = pathToImages + 'close_c.png';
	img.style.styleFloat = 'right';
...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput,languageCode)
{
