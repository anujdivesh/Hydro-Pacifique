...
function scrolldiv_initScroll()
{
	...
	document.getElementById('scrolldiv_scrollDown').onmouseover = scrolldiv_scrollButton;
	document.getElementById('scrolldiv_scrollUp').onmouseover = scrolldiv_scrollButton;
