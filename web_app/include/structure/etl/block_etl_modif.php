...
----------------------------------------
Ce block permet de modifier un ETL
Il est accessible à partir de la page modif_etl.php 
----------------------------------------
*/

echo "<div id='box_elt_modif' class='block_view' style='width:450px;height:300px;margin-left:35%;background:transparent;'>\n"; // style='background:transparent;'
    ...
    echo "<div id='cadre_view_2' style='padding:0px;background-color:#FBF9F1;' >\n";
        ...
        echo "<div>";	
            ...
            echo "<p style='float:left;width:100%;height:30px;padding-left:8px;font-size:18px;font-weight:bold;color:#fff;margin:0px;background-color:#000;'>";
                echo htmlaccent('Modifier la période de validité d\'un ETL');
            echo "</p>\n";  
		...
		echo "<div style='margin: 0 5%;margin-top:55px;'>";	
            ...
            echo "<div style='width:100%;'>";
                ...
                echo "<select name='modif_ref_etl' id='modif_ref_etl' style='width:90%;height:35px;font-size:12px;' onchange='modifUpdateFieldsDate(this.value)'>";
            ...
            echo "<div style='width:100%;margin-top:25px;'>";
                    ...
                    echo "<table style='font-size:12px;'>";
                        ...
                        echo "<tr>";
                            echo "<td>";
                                echo "<input style='width:90px;height:20px;font-size:14px;' id='modif_date_debut_periode' type='text' value=''  >\n"; 
                            echo "</td>";
                            echo "<td>";
                                echo "<input style='width:90px;height:20px;font-size:14px;' id='modif_heure_debut_periode' type='text' value=''>\n"; 
                            echo "</td>";
                        echo "</tr>";
                    ...
                    echo "<table style='font-size:12px;'>";
                        ...
                        echo "<tr>";
                            echo "<td>";
                                echo "<input style='width:90px;height:20px;font-size:14px;' id='modif_date_fin_periode' type='text' value=''  >\n"; 
                            echo "</td>";
                            echo "<td>";
                                echo "<input style='width:90px;height:20px;font-size:14px;' id='modif_heure_fin_periode' type='text' value=''>\n"; 
                            echo "</td>";
                        echo "</tr>";
            ...
            echo "<div style='float:left;margin-top:25px;'>";
                ...
                echo "<input type='submit' style='float:left;width:120px;' class='button' name='modif_etl' id='modif_etl' value='Modifier' >";
...
<script>
	...
	document.addEventListener("keydown", function(event) 
	{
		if (event.key === "Escape") 
		{
			...
			box_elt_modif.style.display = "none";
		}
    });
    ...
    function modifUpdateFieldsDate(selectedValue) 
    {
        ...
        {
            modifDateDebut.value = '';
            modifHeureDebut.value = '';
            modifDateFin.value = '';
            modifHeureFin.value = '';
        }
    }
