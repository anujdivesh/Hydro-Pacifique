...
$id_user = $dataInfo['idUser'];
$map_zoom = $dataInfo['mapZoom'];
$map_long = $dataInfo['mapLong'];
$map_lat = $dataInfo['mapLat'];

// Mise à jour de la table TABLE_USER_MENU 
$sql_coord = "INSERT INTO ".TABLE_USER_COORD." (id_user, map_zoom, map_long, map_lat)
                VALUES (?, ?, ?, ?)
                ON DUPLICATE KEY UPDATE map_zoom = VALUES(map_zoom), map_long = VALUES(map_long), map_lat = VALUES(map_lat)";
