...
$num_appareil = '';
$heure_appareil = '';
$plu_taille_auget = ''; // pour appareil plu
...
// Observations	
$check_bouchage = 0; // checked box 0 ou 1 
$check_huile = 0; // checked box 0 ou 1 
...
{    
    ...
    {  
        ...
        $RA_tab = tep_db_fetch_array($RA_query);
            ...
            $plu_taille_auget = $RA_tab['plu_taille_auget']; // pour appareil plu
            ...
            // Observations	
            $check_bouchage = $RA_tab['plu_ra_bouchage']; // checked box 0 ou 1 
            $check_huile = $RA_tab['plu_ra_huile_tot']; // checked box 0 ou 1 
                ...
                if($ra_exist)
                {
                    ...
                    $tab_html .= "<table id='tab_titre_popup' cellspacing='0'>";
                        ...
                        $tab_html .= "<tr>";
                            ...
                            $tab_html .= "<td class='titre'>";
                                ...
                                // Puce validation RA 
                                if($etat_ra > 0){$tab_html .= "<img src='".DIR_WS_IMG_ICO."puce_verte.png' id='valid_puce_ok' style='margin-left:4%;' title='".htmlaccent('RA validé')."'>";}
                                else{$tab_html .= "<img src='".DIR_WS_IMG_ICO."puce_rouge.png' id='valid_puce_no' style='margin-left:4%;' title='".htmlaccent('RA non validé')."'>";}
                    ...
                    $tab_html .= "<div id='boxpopup' class='elt_boite_plu'>\n";
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_tot_type' id='plu_tot_type' value='".$plu_tot_type."' class='input_texte_small' type='text'>";
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_tot_first' id='plu_tot_first' value='".$plu_tot_first."' class='input_texte_small' type='text'>";	
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_tot_last' id='plu_tot_last' value='".$plu_tot_last."' class='input_texte_small' type='text'>";	
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_tot_heure_basc' id='plu_tot_heure_basc' value='".$plu_tot_heure_basc."' class='input_texte_small' type='text'>";	
                    ...
                    $tab_html .= "<div id='boxpopup' class='elt_boite_plu' >\n";
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_cumul_tot' id='plu_cumul_tot' value='".$plu_cumul_tot."' class='input_texte_small' type='text'>";
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_cumul_plu' id='plu_cumul_plu' value='".$plu_cumul_plu."' class='input_texte_small' type='text'>";	
                                    
                        $tab_html .= "</div>\n";
                        
                        $plu_diff_tot_plu = (float)$plu_cumul_tot - (float)$plu_cumul_plu;
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_recalage_heure_plu' id='plu_recalage_heure_plu' value='".$plu_recalage_heure_plu."' class='input_texte_small' type='text'>";	
                        ...
                        $tab_html .= "<div id='boite_small'>\n";
                            ...
                            $tab_html .= "<input name='plu_test_auget' id='plu_test_auget' value='".$plu_test_auget."' class='input_texte_small' type='text'>";	
                    ...
                    $tab_html .= "<div id='boxpopup'>\n";
                        ...
                        // PLU
                        $tab_html .= "<div id='boite_small' class='elt_boite_plu' >\n";
                                
                            $tab_html .= "<p>".htmlaccent('Nb basculements')."</p>";		
                            $tab_html .= "<input name='plu_nb_basculement' id='plu_nb_basculement' value='".$plu_nb_basculement."' class='input_texte_xsmall' type='text'>";	
                    ...
                    $tab_html .= "<div id='boxpopup' class='elt_boite_pluhydro' >\n";
                        ...
                        $tab_html .= "<div id='boite_small' class='elt_boite_plu'>\n";
                            ...
                            $tab_html .= "<p>".htmlaccent('Heure du 1er bascul.')."</p>";		
                            $tab_html .= "<input name='plu_heure_bascul1_cassette' id='plu_heure_bascul1_cassette' value='".$plu_heure_bascul1_cassette."' class='input_texte_small' type='text'>";	
                    ...
                    $tab_html .= "<div id='boxpopup'>\n";
                        ...
                        $tab_html .= "<div id='boite_small' class='elt_boite_pluhydro' style='margin:0;' >\n";
                            ...
                            $tab_html .= "<div class='elt_boite_plu' >\n";
                                $tab_html .= "<input class='input_texte' style='width:25px;' name='check_bouchage' id='check_bouchage' type='checkbox' ".$checked.">";
                                $tab_html .= "<span style='float:left;margin-top:5px;width:90px;font-size:12px;'>".htmlaccent('Bouchage')."</span>";													
                                $tab_html .= "<hr>";
                            $tab_html .= "</div>\n";
                            ...
                            $tab_html .= "<div class='elt_boite_plu' >\n";
                                ...
                                $tab_html .= "<span style='float:left;margin-top:5px;width:90px;font-size:12px;'>".htmlaccent('Huile TOT')."</span>";													
                                $tab_html .= "<hr>";
                            $tab_html .= "</div>\n";
